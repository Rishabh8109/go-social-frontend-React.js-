  ...
  return (
    <div className="card">
      ...
      <div className="cardBody">
        <div className="arrowBack" onClick={scrollBackHandler} ref={arrowRef}>
          <IoIosArrowBack />
         </div>
        <ul ref={scrollRef}>
          <li>
            <FiPlus className="addIcon" /> <p>Create Your Story</p>
          </li>
        ...
        <div className="arrowForward" onClick={scrollForwardHandler}>
          <IoIosArrowForward />
        </div>
      </div>
    </div>
